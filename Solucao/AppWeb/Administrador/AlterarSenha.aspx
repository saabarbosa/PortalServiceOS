<%@ Page Title="Apparato" Language="C#" MasterPageFile="~/Administrador/Private.master" AutoEventWireup="true" CodeFile="AlterarSenha.aspx.cs" Inherits="Administrador_AlterarSenha" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" Runat="Server">
    <table style="margin-left: 20px; width: 95%; margin-right: 20px; height: 30px">
        ...
        <tr>
            ...
            <td>
                <br />
                Deseja mesmo resetar senha do cliente acima ?<br />
                <br />

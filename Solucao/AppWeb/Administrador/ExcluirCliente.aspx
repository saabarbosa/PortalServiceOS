<%@ Page Title="Apparato" Language="C#" MasterPageFile="~/Administrador/Private.master" AutoEventWireup="true" CodeFile="ExcluirCliente.aspx.cs" Inherits="Administrador_ExcluirCliente" %>
    ...
    <div>
        ...
        <table style="margin-left: 20px; width: 95%; margin-right: 20px; height: 30px">
            <tr>
                ...
                <td>
                    <asp:Label ID="lblCpfCnpj" runat="server"></asp:Label></td>
            </tr>
        </table>
        <table style="margin-left: 20px; width: 95%; margin-right: 20px; height: 30px">
            <tr>
                <td>
                    ...
                    &nbsp;<asp:Label ID="lblSucesso" runat="server" ForeColor="Green" Text="Cliente excluído com sucesso."

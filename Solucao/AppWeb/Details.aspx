<%@	Page Language="C#" MasterPageFile="~/Default.master" Title="Apparato"
		...
		<asp:formview id="FormView1" runat="server"	datasourceid="ObjectDataSource1" cssclass="view"
			...
			<itemtemplate>
				...
				<table border="0" cellpadding="0" cellspacing="0" class="photo-frame">
					...
					<tr>
						<td class="midx--"></td>
						<td><img src="Handler.ashx?PhotoID=<%# Eval("PhotoID") %>&Size=L" class="photo_198" style="border:4px solid white" alt='Photo Number <%# Eval("PhotoID") %>' /></a></td>
						<td class="mid--x"></td>
					</tr>
					<tr>
						<td class="botx--"></td>
